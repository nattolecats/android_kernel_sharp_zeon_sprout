...
u8 exfat_get_entry_create_utc_offset(struct dentry_t *p_entry)
{
	struct file_dentry_t *ep = (struct file_dentry_t *)p_entry;

	return ep->create_utc_offset;
}

void exfat_set_entry_create_utc_offset(struct dentry_t *p_entry, u8 utc_offset)
{
	struct file_dentry_t *ep = (struct file_dentry_t *)p_entry;

    ep->create_utc_offset = utc_offset;
}

u8 exfat_get_entry_modify_utc_offset(struct dentry_t *p_entry)
{
	struct file_dentry_t *ep = (struct file_dentry_t *)p_entry;

	return ep->modify_utc_offset;
}

void exfat_set_entry_modify_utc_offset(struct dentry_t *p_entry, u8 utc_offset)
{
	struct file_dentry_t *ep = (struct file_dentry_t *)p_entry;

    ep->modify_utc_offset = utc_offset;
}

u8 exfat_get_entry_access_utc_offset(struct dentry_t *p_entry)
{
	struct file_dentry_t *ep = (struct file_dentry_t *)p_entry;

	return ep->access_utc_offset;
}

void exfat_set_entry_access_utc_offset(struct dentry_t *p_entry, u8 utc_offset)
{
	struct file_dentry_t *ep = (struct file_dentry_t *)p_entry;

    ep->access_utc_offset = utc_offset;
}
...
static struct fs_func exfat_fs_func = {
	...
	.get_entry_create_utc_offset = exfat_get_entry_create_utc_offset,
	.set_entry_create_utc_offset = exfat_set_entry_create_utc_offset,
	.get_entry_modify_utc_offset = exfat_get_entry_modify_utc_offset,
	.set_entry_modify_utc_offset = exfat_set_entry_modify_utc_offset,
	.get_entry_access_utc_offset = exfat_get_entry_access_utc_offset,
	.set_entry_access_utc_offset = exfat_set_entry_access_utc_offset,
};
