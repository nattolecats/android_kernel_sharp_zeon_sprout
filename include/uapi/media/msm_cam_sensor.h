...
#define SHCAM_LED_PREFLASH_CURRENT 250
#define SHCAM_LED_FLASH_CURRENT 1300
/* SHLOCAL_CAMERA_DRIVERS<- */
...
struct ois_pram_t {
	uint16_t sfthal_x_still;
	uint16_t sfthal_y_still;
};
/* SHLOCAL_CAMERA_DRIVERS<- */
...
/* SHLOCAL_CAMERA_DRIVERS-> */
	...
	SHCFG_OIS_FW_INIT,
	SHCFG_OIS_PARAM_INIT,
/* SHLOCAL_CAMERA_DRIVERS<- */
/* SHLOCAL_CAMERA_IMAGE_QUALITY-> */ /* Built-in Hybrid AF */
	SHCFG_WRITE_I2C_ARRAY_WAIT_OIS,
/* SHLOCAL_CAMERA_IMAGE_QUALITY<- */ /* Built-in Hybrid AF */
};
