...
static const struct qpnp_vadc_map_pt adcmap_batt_therm_pu100_b4250[] = {
	{1840,	-400},
	{1835,	-380},
	{1828,	-360},
	{1821,	-340},
...
#ifdef CONFIG_BATTERY_SHARP
int32_t qpnp_adc_batt_therm_pu100_b4250(struct qpnp_vadc_chip *chip,
		int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	if (adc_properties->adc_hc) {
		...
		batt_thm_voltage = div64_s64(batt_thm_voltage,
				adc_properties->full_scale_code * 1000);
		qpnp_adc_map_voltage_temp(adcmap_batt_therm_pu100_b4250,
			ARRAY_SIZE(adcmap_batt_therm_pu100_b4250),
			batt_thm_voltage, &adc_chan_result->physical);
	}
	return 0;
}
EXPORT_SYMBOL(qpnp_adc_batt_therm_pu100_b4250);
#endif /* CONFIG_BATTERY_SHARP */
